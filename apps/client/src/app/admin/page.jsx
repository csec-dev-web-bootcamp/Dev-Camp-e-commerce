  ...
  return (
    <div className="">
      <div className='flex w-screen bg-gray-100 shadow-sm'>
        <div className='mx-20 my-5'><h1 className='text-3xl' >Admin</h1></div>

        <div className='flex mx-48 my-5'>
          <div className='mx-10'><h2 className='text-xl '>Overview</h2></div>
        ...
        <div className='flex justify-end my-5'>
          <div className='mx-5 '><IoIosNotificationsOutline className='w-7 h-7'/></div>
          <div className='mx-5 '><BsCart2 className='w-7 h-7'/></div>
      ...
      <div className='flex h-screen  bg-gray-100 '>
        <div className='  w-1/3  flex justify-center' >
          <div className=''>
          <div className=' w-full h-screen scrollbar scrollbar-thumb-sky-700 scrollbar-track-sky-300  overflow-y-scroll'>
            
              <div className='border items-center bg-white rounded-md py-4 px-16  shadow-md flex hover:text-blue-500 mb-2'> 
                  <div>< MdManageAccounts className='flex justify-items-start'/></div>
              ...
              <span className='flex justify-items-start px-16 '>
                ...
                <div className='border  bg-white rounded-full py-3 px-16  shadow-md flex hover:text-blue-500 my-5'>
                        <div> <AiFillSignal className='w-7 h-7 mr-4'/> </div>
                        <div>Dashboard</div>
                </div>
                </Link>

              {sideBar.map(({ Icon, name,slug }, ind) => (
                // 
                <Link key={ind} href={`/admin?dashboard=${slug}`}>
                    <div className=' items-center   py-3 px-20     flex hover:text-blue-500 mb-3'>
                        <div> <Icon className='w-7 h-7 mr-3'/> </div>
                        <div>{name}</div>
                        {/* <div><Arrow/></div> */}
                    </div>
                </Link>
