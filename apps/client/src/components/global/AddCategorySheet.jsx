...
export default function AddCategorySheet({ categories }) {
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <button className="px-10 py-3.5 border rounded border-color-primary text-color-primary transition-all ease-in-out duration-200 hover:bg-color-primary hover:text-color-border-light">
          + Add New
        </button>
      </SheetTrigger>
        ...
        <div>
          ...
          >
            <div className="bg-white p-8 rounded">
              {error && (
                <small className="text-color-chart03 mb-3">{error}</small>
              )}
            ...
            <div className="bg-white p-4 flex flex-col justify-between rounded">
              <div className="">
                ...
                <div className="relative w-full">
                  <div className="w-full relative h-[200px] border-dashed border rounded border-[#2275fc] flex flex-col items-center cursor-pointer justify-center">
